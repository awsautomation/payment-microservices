 ...
 *
 */
public class CreateAuthRequestVDP {
	...
	public String toString() {
		return "AuthRequestVDP [payment=" + payment + ", amount=" + amount + ", currency=" + currency + ", referenceId="
	...
	public static class Builder {
		...
		public CreateAuthRequestVDP build() {
			return new CreateAuthRequestVDP(this);
		}
	}

	private CreateAuthRequestVDP(Builder builder) {
