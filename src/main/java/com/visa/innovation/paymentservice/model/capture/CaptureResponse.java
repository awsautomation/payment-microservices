...
//TODO: inheritance with along with AuthResponse class
...
public class CaptureResponse {
	...
	public String toString() {
		return "{ \"captureId\"" +":" + captureId + ", \"authorizationId\""+":" + authorizationId + ", \"amount\""+":" + amount
				+ ",\"currency\""+":" + currency + ",\"orderId\""+":" + orderId + ",\"created\""+":" + created + ",\"updated\""+":" + updated
				+ ",\"validUntil\""+":" + validUntil + ",\"merchantId\""+":" + merchantId + ",\"userId\""+":" + userId + ",\"status\""+":"
	...
	private CaptureResponse(Builder builder) {
